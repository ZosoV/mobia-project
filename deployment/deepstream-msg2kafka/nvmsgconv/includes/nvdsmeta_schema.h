...
typedef struct NvDsCarObject {
  ...
  gchar *color;     /**< Holds a pointer to the color of the car. */
  gchar *region;    /**< Holds a pointer to the region of the car. */
  gchar *license;   /**< Holds a pointer to the license number of the car.*/
